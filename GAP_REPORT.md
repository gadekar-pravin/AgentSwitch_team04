...
|---|---|---|---|
| **Capacity-aware scheduling** | Places operations within work-centre hours, subtracts maintenance downtime, reserves qualified operators | The schedule projects open orders to finish today and models neither work calendars nor labour. Whether recorded downtime now reduces capacity is *untested* | **Platform defect and model gap** |
| **Specific delay reasons** | Operation-level reasons: waiting behind a named job, a work centre, or an operator | On 17 Sep, 50 of 51 late Suryodaya orders got one generic cause. The schedule now also cites recorded downtime, but never "waiting behind a job" or "no operator" | **Agent partly**; platform output gap |
